...
import { OffsetOptions, Placement, ReferenceType, UseFloatingReturn, VirtualElement } from '@floating-ui/react-dom';
import { buildListboxCollection, ListboxCollection } from './build-listbox-collection';
...
type SelectionProps = NoneSelectionProps | SingleSelectionProps | MultipleSelectionProps;
...
export interface UseListboxReturn {
    ...
    focusItem: (fallbackOperation: 'increment' | 'decrement', newIndex: number) => void;
    allowCustomValue: ListboxProps['allowCustomValue'];
