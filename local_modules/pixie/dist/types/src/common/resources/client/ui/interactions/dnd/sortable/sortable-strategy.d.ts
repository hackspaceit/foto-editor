import type { DropPosition, SortSession } from '@common/ui/interactions/dnd/sortable/use-sortable';
...
export interface SortableStrategy {
    ...
    onDragEnter: (sortSession: SortSession, overIndex: number, currentIndex: number) => void;
