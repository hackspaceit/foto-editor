...
export declare function GradientBackgroundTab({ value, onChange, className, isInsideDialog, }: BgSelectorTabProps<BackgroundSelectorConfig>): import("react/jsx-runtime").JSX.Element;
