...
export declare function AdvancedBackgroundPositionSelector({ value, onChange, }: BgSelectorTabProps<BackgroundSelectorConfig>): import("react/jsx-runtime").JSX.Element;
